                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="small text-secondary mb-2">
                                    <span class="badge small vm text-template" :class="[{ 'badge-info' :  item.accept_status == 0 ,'badge-success' :  item.accept_status == 1 ,'badge-danger' :  item.accept_status != 0 && item.accept_status != 1 } ] ">{{ toStatusString(item.accept_status) }}</span>
                                </p>

  ...
  <div>
              ...
              <div class="row justify-content-center">
                <div class="fetch justify-content-center">
                  <button class="btn btn-default border-1 btn-rounded-54 p-1 shadow" @click="fetchUser">
                    <i
                      class="material-icons text-template size-16 bg-white"
                      :class="{'spin' : isSpin}"
                ...
                <div class="col-12 text-center pt-2" style="border-top: 1px solid #e4e9f0;">
                  <div class="row text-template justify-content-center d-flex align-items-center ">
                    <div class="bg-template" 
                        style="position:absolute;width:60px;left:10%; border-radius: 50%;">
                      <img
    ...
    <div class="container-sm" style=" max-width: 500px;">
      ...
      <div class="row text-center justify-content-center mt-3 pt-2" style="background: #fff; border-bottom-left-radius: 20px; border-top-left-radius: 20px; margin-left: 5px; padding-right: 25px;filter: drop-shadow(0px 1px 1px #25968f);">
        ...
        <div class="col-3" id="btn-luckywheel" 
        style="background: linear-gradient(180deg, #ff975600 36%, #cbf594 100%);"
        ...
        <div
          class="col-3"
          id="btn-activity"
          v-if="this.getPromotionObjects[111].status || this.getPromotionObjects[103].status || this.getPromotionObjects[116].status || this.getPromotionObjects[126].status"
        >
  ...
  methods: {
      ...
      this.$axios
        ...
        .then((response) => {
          if (response.success === true) {
            ...
            this.$toast.global.success({ message: "กรุณารอสักครู่..." });
    ...
    exchangeCredit: async function () {
      ...
      if (success) {
        ...
        this.$toast.global.error({ message: message });
        loader.hide();
      }
    },

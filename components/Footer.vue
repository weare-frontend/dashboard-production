      ...
      <div class="col-auto mx-auto">
        ...
        >
          ...
          <div class="col-2">
            <a
              target="_blank"
              :href="'http://line.me/ti/p/'+ $auth.user.line_agent"
    ...
    >
      ...
      <div class="row justify-content-center">
        <div class="col-12 mb-3">
          <a
            v-if="lunchGameUrlWeb || lunchGameUrlMoblie"
        ...
        <div class="col-12 mb-3" v-if="this.$auth.user.game.toLowerCase() == 'slotxo'">
          <form
            target="_blank"
            ref="formSlotxo"
            action="https://slotxo.com/SignIn"
            class="form-playgame"
            method="post"
          >
        ...
        <div
          class="col-12 mb-3"
          v-if="this.$auth.user.game.toLowerCase() == 'apijoker' "
        >
          <form
            target="_blank"
            ref="formJoker"
            action="http://www.joker1919.net/SignIn"
            class="form-playgame"
            method="post"
          >
            <input type="hidden" name="Username" v-model="this.$auth.user.account_api" value />
...
.footer a.menu-btn-center{
   background:#fff;
   filter: drop-shadow(0px 3px 1px #25968f);
}
.module {
